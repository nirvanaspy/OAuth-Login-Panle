<template>
  <div class="project-container">
      ...
      <div class="right-menu">
        <el-dropdown class="avatar-container right-menu-item" trigger="click">
          <div class="avatar-wrapper">
            <!--<pan-thumb class="proImg" width="40px" height="40px" image="./logo1.svg">
            </pan-thumb>-->
            <!--<img  src="./2.jpg">-->
      ...
      <el-table :key='tableKey'
        ...
        <el-table-column align="center" :label="$t('table.actions')" width="230" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            ...
            <el-button size="mini" plain type="danger" @click="handleDelete(scope.row)">{{$t('table.delete')}}
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="40%">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-width="70px" style='width: 80%;margin: 0 auto'>
